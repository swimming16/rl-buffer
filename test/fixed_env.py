...
class Environment:
    def __init__(self, all_cooked_time, all_cooked_bw, random_seed=RANDOM_SEED):
        ...
        #put file of video_size_n  data into video_size
        ...
        with open(VIDEO_SIZE_FILE+str(bitrate))as f:
            for line in f:
                self.video_size[0].append(int(line.split()[0]))
    ...
    def get_video_chunk(self, quality):
        ...
        while True:  # download video chunk over mahimahi
            ...
            #a chunk has been sent completely
            if video_chunk_counter_sent + packet_payload > video_chunk_size:
                # print('true')

                #fractional_time:a chunk download time
            ...
            #a chunk has not sent completely
        ...
        #print(delay,self.last_mahimahi_time)
